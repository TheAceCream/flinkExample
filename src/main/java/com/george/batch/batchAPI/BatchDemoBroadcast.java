 ...
 *
 * 分析：
 * 所以需要在中间的map处理时，获取用户的年龄信息
 * 建议把用户的关系数据集用广播变量进行处理。
 *
...
public class BatchDemoBroadcast {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 1.1处理需要广播的数据 把数据集转换成map类型，map中的key就是用户姓名 value就是用户年龄
        ...
        }).withBroadcastSet(toBroadcast,"broadCastMapName"); //2.执行广播数据 操作
